...
pub fn init_database(conn: &Connection) {
    ...
    if user_count == 1 {
        let blood_types = vec![
            ...
            "Blood Type A Secretor Teacher",
			"Blood Type A Secretor Explorer",
			"Blood Type A Secretor Warrior",
            "Blood Type A Non-Secretor Teacher",
			"Blood Type A Non-Secretor Explorer",
			"Blood Type A Non-Secretor Warrior",
            "Blood Type AB Secretor Teacher",
			"Blood Type AB Secretor Explorer",
			"Blood Type AB Secretor Warrior",
            "Blood Type AB Non-Secretor Teacher",
			"Blood Type AB Non-Secretor Explorer",
			"Blood Type AB Non-Secretor Warrior",
            "Blood Type B Secretor Gatherer",
			"Blood Type B Secretor Explorer",
			"Blood Type B Secretor Nomad",
            "Blood Type B Non-Secretor Gatherer",
			"Blood Type B Non-Secretor Explorer",
			"Blood Type B Non-Secretor Nomad",
            "Blood Type O Secretor Hunter",
			"Blood Type O Secretor Gatherer",
			"Blood Type O Secretor Explorer",
            "Blood Type O Non-Secretor Hunter",
            "Blood Type O Non-Secretor Gatherer",
            "Blood Type O Non-Secretor Explorer"
        ];
