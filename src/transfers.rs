    ...
    if product_query.is_err() {
        return Flash::success(
            ...
            if templatedir.0 {
                ...
                "Product must be assigned to the profile of a protocol first. Click your browser's back to previous page button and click 'Assign your sensitivity and values'."
            },
        );
    }
